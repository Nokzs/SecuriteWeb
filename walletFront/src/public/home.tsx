      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <section className="mb-16 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Trouvez et contactez directement les syndics disponibles. Utilisez
            la barre de recherche ci-dessous pour trouver le syndic qui vous
            convient.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-purple-50 rounded-lg p-6 border border-purple-200">
            ...
            <p className="text-gray-600">
              Recherchez par nom, prénom, téléphone ou email en quelques
              secondes
            </p>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg text-white p-12 text-center">
          ...
          <p className="text-lg mb-8 opacity-90">
            Connectez-vous pour accéder à plus de fonctionnalités et gérer vos
            propriétés
          </p>
