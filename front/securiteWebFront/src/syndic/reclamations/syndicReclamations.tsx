      ...
      <div className="bg-amber-50 border-l-4 border-amber-600 p-4 rounded-lg mb-8 flex gap-3">
        ...
        <div>
          ...
          <p className="text-amber-800 text-sm mt-1">
            Vous pouvez ignorer un incident ou lancer un vote pour financer sa
            résolution auprès des propriétaires.
          </p>
        </div>
      </div>
            ...
            <div className="space-y-6 mb-8">
              <div className="border-b border-slate-100 pb-4">
                ...
                <p className="text-slate-800 font-medium text-lg">
                  {selectedIncident.ownerFirstName}{" "}
                  {selectedIncident.ownerLastName}
                </p>
              ...
              <div className="border-b border-slate-100 pb-4">
                ...
                <p className="text-slate-800 font-medium">
                  {selectedIncident.buildingName}
                </p>
                <p className="text-sm text-slate-600">
                  {selectedIncident.buildingAddress}
                </p>
